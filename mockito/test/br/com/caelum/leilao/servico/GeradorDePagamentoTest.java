...
public class GeradorDePagamentoTest {
	...
	public void deveGerarPagamentoParaUmLeilaoEncerrado() {
		...
		/*
		 * Veja que o ArgumentCaptor possibilita capturar a instância que foi
		 * passada para o Mock (No caso Pagamento). Isso é especialmente útil em
		 * situações como essas: nossa classe de produção instancia um novo
		 * objeto, que é passado para uma das dependências. Assim, conseguimos
		 * garantir que o objeto criado está correto.
		 * 
		 */
